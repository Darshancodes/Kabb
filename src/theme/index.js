export default {
  ...
  colors: {
    ...
    background_secondary: '#F9FBFD', //0F2137 secondary background color
    border_color: '#E5ECF4', // border color
    primary: '#7851A9', // primary button and link color
    secondary: '#FF90B3', // secondary color - can be used for hover states
