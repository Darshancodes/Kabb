...
import CoreFeatureThumb from 'assets/why-us 1.png';
import Quality from 'assets/core-feature/Quality.svg';
  ...
  features: [
    {
      ...
      title: 'Secure',
      text:
        'Our platform has new-to-market security features making travel seamless.',
    },
    {
      id: 2,
      imgSrc: Quality,
...
export default function CoreFeature() {
  return (
    <section sx={styles.coreFeature} id="whyUs">
